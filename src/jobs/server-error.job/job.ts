...
function buildDomainFindings(rows: ServerErrorLogRow[], excludedDomains: string[]): DomainErrorFinding[] {
    const domainStats = new Map<string, Omit<DomainErrorFinding, 'domain' | 'errorRatePercent'>>();
